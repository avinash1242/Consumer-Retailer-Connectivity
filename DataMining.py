#   AV
#   Apriori Algorithem - Data mining
#   Takes input through function call - file name, minimum support, minimum confidence
#   Creates  text file "ResultDB.Txt" with all the association rules formed



def launchDM(fileName, minimumSupport, minimumConfidence):
    ...
    #   Returns 8 if no rules found, else 1
    ...
    def aprioriOutput(rules, dataSet, minimumSupport, minimumConfidence):
        ...
        for rule in rules:
            ...
            if confidence >= minimumConfidence:
                ...
                confidenceAppendString = "Confidence of X --> Y : " + str(round(confidence))
